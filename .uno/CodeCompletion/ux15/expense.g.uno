...
public partial class expense: Fuse.Controls.Page
{
    ...
    {
        [Uno.WeakReference] internal readonly expense __parent;
        [Uno.WeakReference] internal readonly expense __parentInstance;
        public Template(expense parent, expense parentInstance): base(null, false)
        {
            __parent = parent;
        ...
        public override object New()
        {
            ...
            __self.SourceFileName = "Pages/account/expense.ux";
            return __self;
        }
    }
    [Uno.Compiler.UxGenerated]
    public partial class Template1: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly expense __parent;
        [Uno.WeakReference] internal readonly expense __parentInstance;
        public Template1(expense parent, expense parentInstance): base(null, false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            ...
            temp.SourceFileName = "Pages/account/expense.ux";
            temp.Bindings.Add(temp13);
            temp4.SourceLineNumber = 17;
            temp4.SourceFileName = "Pages/account/expense.ux";
            ...
            temp1.SourceFileName = "Pages/account/expense.ux";
            temp1.Bindings.Add(temp14);
            temp5.SourceLineNumber = 18;
            temp5.SourceFileName = "Pages/account/expense.ux";
            temp2.FontSize = 25f;
            ...
            temp2.SourceFileName = "Pages/account/expense.ux";
            temp2.Bindings.Add(temp15);
            temp9.SourceLineNumber = 19;
            temp9.SourceFileName = "Pages/account/expense.ux";
            temp6.SourceLineNumber = 19;
            temp6.SourceFileName = "Pages/account/expense.ux";
            temp8.SourceLineNumber = 19;
            temp8.SourceFileName = "Pages/account/expense.ux";
            ...
            temp16.Margin = float4(10f, 0f, 0f, 0f);
            temp16.SourceLineNumber = 23;
            temp16.SourceFileName = "Pages/account/expense.ux";
            ...
            temp3.SourceFileName = "Pages/account/expense.ux";
            temp3.Bindings.Add(temp17);
            temp10.SourceLineNumber = 24;
            temp10.SourceFileName = "Pages/account/expense.ux";
    ...
    void InitializeUX()
    {
        ...
        temp_eb18 = new global::Fuse.Reactive.EventBinding(temp3);
        var temp16 = new global::Fuse.Controls.Rectangle();
        this.SourceLineNumber = 1;
        this.SourceFileName = "Pages/account/expense.ux";
        temp4.LineNumber = 3;
        temp4.FileName = "Pages/account/expense.ux";
        temp4.SourceLineNumber = 3;
        temp4.SourceFileName = "Pages/account/expense.ux";
        temp4.File = new global::Uno.UX.BundleFileSource(import("../../../Pages/accountBook.js"));
        temp5.LineNumber = 4;
        temp5.FileName = "Pages/account/expense.ux";
        temp5.SourceLineNumber = 4;
        temp5.SourceFileName = "Pages/account/expense.ux";
        temp5.File = new global::Uno.UX.BundleFileSource(import("../../../Pages/account/expense.js"));
        temp6.SourceLineNumber = 6;
        temp6.SourceFileName = "Pages/account/expense.ux";
        temp6.Children.Add(temp7);
        temp7.SourceLineNumber = 7;
        temp7.SourceFileName = "Pages/account/expense.ux";
        ...
        theEach.SourceFileName = "Pages/account/expense.ux";
        ...
        temp13.SourceFileName = "Pages/account/expense.ux";
        temp13.Children.Add(temp14);
        temp14.Value = "Loading...";
        temp14.Alignment = Fuse.Elements.Alignment.Center;
        temp14.SourceLineNumber = 33;
        temp14.SourceFileName = "Pages/account/expense.ux";
        temp2.SourceLineNumber = 31;
        temp2.SourceFileName = "Pages/account/expense.ux";
        svp.Name = __selector3;
        svp.SourceLineNumber = 38;
        svp.SourceFileName = "Pages/account/expense.ux";
        svp.ReachedEnd += temp_eb18.OnEvent;
        svp.Each = theEach;
        svp.Bindings.Add(temp_eb18);

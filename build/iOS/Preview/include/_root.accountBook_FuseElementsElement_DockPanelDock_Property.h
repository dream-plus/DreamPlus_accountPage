...
namespace g{struct accountBook_FuseElementsElement_DockPanelDock_Property;}
...
struct accountBook_FuseElementsElement_DockPanelDock_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Elements::Element*> _obj;

    void ctor_3(::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector name);
    static accountBook_FuseElementsElement_DockPanelDock_Property* New1(::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector name);
};
// }

...
struct income : ::g::Fuse::Controls::Page
{
    ...
    static uSStrong<uArray*>& __g_static_nametable1() { return income_typeof()->Init(), __g_static_nametable1_; }
    static ::g::Uno::UX::Selector __selector0_;
    static ::g::Uno::UX::Selector& __selector0() { return income_typeof()->Init(), __selector0_; }
    static ::g::Uno::UX::Selector __selector1_;
    static ::g::Uno::UX::Selector& __selector1() { return income_typeof()->Init(), __selector1_; }
    static ::g::Uno::UX::Selector __selector2_;
    static ::g::Uno::UX::Selector& __selector2() { return income_typeof()->Init(), __selector2_; }
    static ::g::Uno::UX::Selector __selector3_;
    static ::g::Uno::UX::Selector& __selector3() { return income_typeof()->Init(), __selector3_; }

    void ctor_8(::g::Fuse::Navigation::Router* router1);
    void InitializeUX();
    static income* New5(::g::Fuse::Navigation::Router* router1);
};
// }

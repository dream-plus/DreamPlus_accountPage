...
// /usr/local/share/uno/Packages/Fuse.Camera/1.10.0-rc1/Camera.uno
// ---------------------------------------------------------------
...
// private static Uno.Threading.Future<string> CheckUserPermissions(object[] args) :100
...
// private static Uno.Threading.Future<string> RequestUserPermissions(object[] args) :117
...
// private static Uno.Threading.Future<string> CheckUserPermissions(object[] args) [static] :100
...
// private static Uno.Threading.Future<string> RequestUserPermissions(object[] args) [static] :117
...
// internal sealed class ResizeImageCallback :128
// {
...
// public ResizeImageCallback(Uno.Threading.Promise<Fuse.ImageTools.Image> p, int width, int height) :134
...
// public generated Uno.Threading.Promise<Fuse.ImageTools.Image> get_ImagePromise() :130
...
// private generated void set_ImagePromise(Uno.Threading.Promise<Fuse.ImageTools.Image> value) :130
...
// public ResizeImageCallback New(Uno.Threading.Promise<Fuse.ImageTools.Image> p, int width, int height) :134
...
// private void ResolveResized(Fuse.ImageTools.Image img) :148
...
// private void ResolveTaken(Fuse.ImageTools.Image img) :143
void ResizeImageCallback__ResolveTaken_fn(ResizeImageCallback* __this, ::g::Fuse::ImageTools::Image* img)
{
    __this->ResolveTaken(img);
}

// public ResizeImageCallback(Uno.Threading.Promise<Fuse.ImageTools.Image> p, int width, int height) [instance] :134
...
// public generated Uno.Threading.Promise<Fuse.ImageTools.Image> get_ImagePromise() [instance] :130
::g::Uno::Threading::Promise* ResizeImageCallback::ImagePromise()
{
    return _ImagePromise;
}

// private generated void set_ImagePromise(Uno.Threading.Promise<Fuse.ImageTools.Image> value) [instance] :130
void ResizeImageCallback::ImagePromise(::g::Uno::Threading::Promise* value)
{
    _ImagePromise = value;
}

// private void ResolveResized(Fuse.ImageTools.Image img) [instance] :148
...
// private void ResolveTaken(Fuse.ImageTools.Image img) [instance] :143
...
// public ResizeImageCallback New(Uno.Threading.Promise<Fuse.ImageTools.Image> p, int width, int height) [static] :134

...
// /usr/local/share/uno/Packages/Fuse.Camera/1.10.0-rc1/iOS/iOSCamera.uno
// ----------------------------------------------------------------------

// public sealed extern class iOSCamera :9
// {
...
// public generated iOSCamera() :9
void iOSCamera__ctor__fn(iOSCamera* __this)
{
    __this->ctor_();
}

// internal static void CheckPermissions(Uno.Threading.Promise<string> p) :17
void iOSCamera__CheckPermissions_fn(::g::Uno::Threading::Promise* p)
{
    iOSCamera::CheckPermissions(p);
}

// private static void CheckPermissionsInternal(Uno.Action<string> onComplete, Uno.Action<string> onFail) :36
...
// public generated iOSCamera New() :9
void iOSCamera__New1_fn(iOSCamera** __retval)
{
    *__retval = iOSCamera::New1();
}

// internal static void RequestPermissions(Uno.Threading.Promise<string> p) :23
void iOSCamera__RequestPermissions_fn(::g::Uno::Threading::Promise* p)
{
    iOSCamera::RequestPermissions(p);
}

// private static void RequestPermissionsInternal(Uno.Action<string> onComplete, Uno.Action<string> onFail) :50
...
// internal static void TakePicture(Uno.Threading.Promise<Fuse.ImageTools.Image> p) :11
void iOSCamera__TakePicture_fn(::g::Uno::Threading::Promise* p)
{
    iOSCamera::TakePicture(p);
}

// private static void TakePictureInternal(Uno.Action<string> onComplete, Uno.Action<string> onFail) :30
...
// public generated iOSCamera() [instance] :9
void iOSCamera::ctor_()
{
}

// internal static void CheckPermissions(Uno.Threading.Promise<string> p) [static] :17
...
// private static void CheckPermissionsInternal(Uno.Action<string> onComplete, Uno.Action<string> onFail) [static] :36
...
// public generated iOSCamera New() [static] :9
...
// internal static void RequestPermissions(Uno.Threading.Promise<string> p) [static] :23
...
// private static void RequestPermissionsInternal(Uno.Action<string> onComplete, Uno.Action<string> onFail) [static] :50
...
// internal static void TakePicture(Uno.Threading.Promise<Fuse.ImageTools.Image> p) [static] :11
...
// private static void TakePictureInternal(Uno.Action<string> onComplete, Uno.Action<string> onFail) [static] :30

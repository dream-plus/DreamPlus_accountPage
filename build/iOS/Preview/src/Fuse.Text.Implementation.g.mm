...
// /usr/local/share/uno/Packages/Fuse.Text/1.10.0-rc1/Implementation/CoreTextFontFace.uno
// --------------------------------------------------------------------------------------
...
static void CoreTextFont_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.10.0-rc1/Implementation/CoreTextFontFace.uno");
...
// internal CoreTextFont(Uno.IntPtr hbFace, Uno.IntPtr cgFont, ObjC.Object uiFont, int pixelSize) :57
...
// public override sealed float get_Ascender() :82
...
// private float GetAscender(ObjC.Object uiFont) :88
...
// private static Uno.IntPtr GetCTFont(ObjC.Object font) :163
void CoreTextFont__GetCTFont_fn(::g::ObjC::Object* font, void** __retval)
{
    *__retval = CoreTextFont::GetCTFont(font);
}

// private float GetDescender(ObjC.Object uiFont) :90
...
// private float GetLineHeight(ObjC.Object uiFont) :92
...
// internal CoreTextFont New(Uno.IntPtr hbFace, Uno.IntPtr cgFont, ObjC.Object uiFont, int pixelSize) :57
...
// public override sealed int get_NumGlyphs() :85
...
// public override sealed int get_PixelSize() :53
void CoreTextFont__get_PixelSize_fn(CoreTextFont* __this, int32_t* __retval)
{
    return *__retval = __this->_pixelSize, void();
}

// public override sealed Fuse.Text.RenderedGlyph Render(Fuse.Text.Glyph glyph) :96
...
// private byte[] Render(Uno.IntPtr rawFont, uint index, int2& size, float2& offset) :118
...
// private void CGFontRelease(Uno.IntPtr cgFont) [instance] :112
...
// private float GetAscender(ObjC.Object uiFont) [instance] :88
...
// private float GetDescender(ObjC.Object uiFont) [instance] :90
...
// private float GetLineHeight(ObjC.Object uiFont) [instance] :92
...
// private int GetNumGlyphs(Uno.IntPtr cgFont) [instance] :93
int32_t CoreTextFont::GetNumGlyphs(void* cgFont)
{
    return (int32_t)CGFontGetNumberOfGlyphs((CGFontRef)cgFont);
}

// private byte[] Render(Uno.IntPtr rawFont, uint index, int2& size, float2& offset) [instance] :118
...
// private static Uno.IntPtr GetCTFont(ObjC.Object font) [static] :163
...
// internal CoreTextFont New(Uno.IntPtr hbFace, Uno.IntPtr cgFont, ObjC.Object uiFont, int pixelSize) [static] :57
...
// private static byte[] TryConvertRGBAToL8(byte[] buffer) [static] :168

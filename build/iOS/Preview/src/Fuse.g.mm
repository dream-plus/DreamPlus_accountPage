...
// public override sealed Fuse.Visual get_ChildrenVisual() :66
...
// protected override void OnUpdate() :96
...
// /usr/local/share/uno/Packages/Fuse.iOS/1.10.0-rc1/AppRoot.uno
// -------------------------------------------------------------
...
static void GraphicsWorker_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Fuse.Common/1.10.0-rc1/GraphicsWorker.uno");
...
// public static Uno.Rect CompensateForOrientation(Uno.Rect rect) :67
...
// public static Uno.Rect CompensateForOrientation(Uno.Rect rect) [static] :67

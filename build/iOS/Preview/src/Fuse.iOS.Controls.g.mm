...
// public static string GenBaseUrl(string path) :42
...
// public static string GetTitle(ObjC.Object handle) :92
...
// public static string GenBaseUrl(string path) [static] :42
...
// public static string GetTitle(ObjC.Object handle) [static] :92

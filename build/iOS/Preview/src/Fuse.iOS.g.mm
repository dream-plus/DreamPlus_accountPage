...
// /usr/local/share/uno/Packages/Fuse.iOS/1.10.0-rc1/Support.uno
// -------------------------------------------------------------
...
// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoFloat2(float2 unoPoint, float scale) :135
...
// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoInt2(int2 unoPoint, float scale) :127
...
// public static extern int2 CGPointToUnoInt2(Uno.Platform.iOS.uCGPoint point, float scale) :119
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRect(Uno.Rect unoRect, float scale) :143
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRecti(Uno.Recti unoRect, float scale) :153
...
// public static extern Uno.Recti CGRectToUnoRecti(Uno.Platform.iOS.uCGRect rect, float scale) :164
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoFloat2(float2 unoSize, float scale) :188
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoInt2(int2 unoSize, float scale) :180
...
// public static extern int2 CGSizeToUnoInt2(Uno.Platform.iOS.uCGSize size, float scale) :171
void Support__CGSizeToUnoInt2_fn(CGSize* size, float* scale, ::g::Uno::Int2* __retval)
{
    *__retval = Support::CGSizeToUnoInt2(*size, *scale);
}

// public static texture2D CreateTextureFromImage(Uno.Platform.iOS.UIImage image) :18
...
// private static int2 UIImageGetSize(Uno.Platform.iOS.UIImage image) :29
void Support__UIImageGetSize_fn(::UIImage ** image, ::g::Uno::Int2* __retval)
{
    *__retval = Support::UIImageGetSize(*image);
}

// private static byte[] UIImageToRGBA8888(Uno.Platform.iOS.UIImage _image) :39
void Support__UIImageToRGBA8888_fn(::UIImage ** _image, uArray** __retval)
{
    *__retval = Support::UIImageToRGBA8888(*_image);
}

// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoFloat2(float2 unoPoint, float scale) [static] :135
...
// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoInt2(int2 unoPoint, float scale) [static] :127
...
// public static extern int2 CGPointToUnoInt2(Uno.Platform.iOS.uCGPoint point, float scale) [static] :119
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRect(Uno.Rect unoRect, float scale) [static] :143
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRecti(Uno.Recti unoRect, float scale) [static] :153
...
// public static extern Uno.Recti CGRectToUnoRecti(Uno.Platform.iOS.uCGRect rect, float scale) [static] :164
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoFloat2(float2 unoSize, float scale) [static] :188
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoInt2(int2 unoSize, float scale) [static] :180
...
// public static extern int2 CGSizeToUnoInt2(Uno.Platform.iOS.uCGSize size, float scale) [static] :171
...
// public static texture2D CreateTextureFromImage(Uno.Platform.iOS.UIImage image) [static] :18
...
// private static int2 UIImageGetSize(Uno.Platform.iOS.UIImage image) [static] :29
...
// private static byte[] UIImageToRGBA8888(Uno.Platform.iOS.UIImage _image) [static] :39

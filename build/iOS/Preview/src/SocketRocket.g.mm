...
// /usr/local/share/uno/Packages/Fuse.WebSockets/1.10.0-rc1/iOS/SocketRocket/WebSocketClient.uno
// ---------------------------------------------------------------------------------------------
...
// public void SetHeader(string key, string value) :84
...
// public void SetHeader(string key, string value) [instance] :84

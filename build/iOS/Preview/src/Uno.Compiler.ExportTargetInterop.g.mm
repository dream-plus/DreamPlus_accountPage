...
// private static ObjC.Object CreateNSDataFromByteArray(Uno.IntPtr rawUnoArray) :55
...
// private ForeignDataView(sbyte[] data) [instance] :21
...
// private ForeignDataView(Uno.Buffer buffer) [instance] :30
...
// public static Uno.Compiler.ExportTargetInterop.ForeignDataView Create(byte[] unoArray) [static] :37
ForeignDataView* ForeignDataView::Create1(uArray* unoArray)
{
    return ForeignDataView::New4(unoArray);
}

// public static Uno.Compiler.ExportTargetInterop.ForeignDataView Create(sbyte[] unoArray) [static] :42
ForeignDataView* ForeignDataView::Create2(uArray* unoArray)
{
    return ForeignDataView::New5(unoArray);
}

// public static Uno.Compiler.ExportTargetInterop.ForeignDataView Create(Uno.Buffer unoBuffer) [static] :49
ForeignDataView* ForeignDataView::Create3(::g::Uno::Buffer* unoBuffer)
{
    return ForeignDataView::New6(unoBuffer);
}

// private static ObjC.Object CreateNSDataFromByteArray(Uno.IntPtr rawUnoArray) [static] :55
...
// private ForeignDataView New() [static] :12
...
// private ForeignDataView New(byte[] data) [static] :14
...
// private ForeignDataView New(sbyte[] data) [static] :21
...
// private ForeignDataView New(Uno.Buffer buffer) [static] :30

...
// /usr/local/share/uno/Packages/UnoCore/1.10.0-rc1/Source/Uno/Platform/iOS/iOSDisplay.uno
// ---------------------------------------------------------------------------------------
...
static void iOSDisplay_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/UnoCore/1.10.0-rc1/Source/Uno/Platform/iOS/iOSDisplay.uno");

...
// /usr/local/share/uno/Packages/UnoCore/1.10.0-rc1/Source/Uno/Runtime/Implementation/Internal/Unsafe.uno
// ------------------------------------------------------------------------------------------------------
...
// public static extern void Quit() :23
void Unsafe__Quit_fn()
{
    Unsafe::Quit();
}

// public static extern void Quit() [static] :23
void Unsafe::Quit()
{
    @autoreleasepool
    {

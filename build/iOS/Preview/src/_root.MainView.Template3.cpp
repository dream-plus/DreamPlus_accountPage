...
// public partial sealed class MainView.Template3 :101
// {
// static Template3() :110
static void MainView__Template3__cctor__fn(uType* __type)
{
    MainView__Template3::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"accountBook"*/]);
}
...
// public Template3(MainView parent, MainView parentInstance) :105
...
void MainView__Template3__New1_fn(MainView__Template3* __this, uObject** __retval)
{
    ...
    ::g::accountBook* __self1 = ::g::accountBook::New5(uPtr(__this->__parent1)->router);
...
// public Template3 New(MainView parent, MainView parentInstance) :105
...
// public Template3(MainView parent, MainView parentInstance) [instance] :105
void MainView__Template3::ctor_1(::g::MainView* parent, ::g::MainView* parentInstance)
{
    ctor_(::STRINGS[0/*"accountBook"*/], false);
    __parent1 = parent;
    __parentInstance1 = parentInstance;
}

// public Template3 New(MainView parent, MainView parentInstance) [static] :105

...
// public partial sealed class MainView.Template4 :133
// {
// static Template4() :142
static void MainView__Template4__cctor__fn(uType* __type)
{
    MainView__Template4::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"income"*/]);
}

static void MainView__Template4_build(uType* type)
{
    ::STRINGS[0] = uString::Const("income");
...
// public Template4(MainView parent, MainView parentInstance) :137
...
void MainView__Template4__New1_fn(MainView__Template4* __this, uObject** __retval)
{
    ...
    ::g::income* __self1 = ::g::income::New5(uPtr(__this->__parent1)->router);
...
// public Template4 New(MainView parent, MainView parentInstance) :137
...
// public Template4(MainView parent, MainView parentInstance) [instance] :137
void MainView__Template4::ctor_1(::g::MainView* parent, ::g::MainView* parentInstance)
{
    ctor_(::STRINGS[0/*"income"*/], false);
    __parent1 = parent;
    __parentInstance1 = parentInstance;
}

// public Template4 New(MainView parent, MainView parentInstance) [static] :137

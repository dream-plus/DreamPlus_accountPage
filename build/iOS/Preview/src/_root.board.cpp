...
// {
// static board() :5
static void board__cctor_4_fn(uType* __type)
{
}

static void board_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Pages/board.ux");
    ...
    type->SetFields(126,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(board, router), 0);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)board__New5_fn, 0, true, type, 1, ::g::Fuse::Navigation::Router_typeof()));
}
...
::g::Fuse::Controls::Panel_type* board_typeof()
{
    ...
    options.ObjectSize = sizeof(board);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("board", options);
    type->fp_build_ = board_build;
    type->fp_cctor_ = board__cctor_4_fn;
...
// public board(Fuse.Navigation.Router router) :9
...
// public board New(Fuse.Navigation.Router router) :9
void board__New5_fn(::g::Fuse::Navigation::Router* router1, board** __retval)
{
    *__retval = board::New5(router1);
}

// public board(Fuse.Navigation.Router router) [instance] :9
void board::ctor_8(::g::Fuse::Navigation::Router* router1)
{
    uStackFrame __("board", ".ctor(Fuse.Navigation.Router)");
    ctor_7();
    router = router1;
    InitializeUX();
}
...
void board::InitializeUX()
{
    uStackFrame __("board", "InitializeUX()");
    ::g::Fuse::Controls::Panel* temp = ::g::Fuse::Controls::Panel::New3();
    ::g::Fuse::Controls::Image* temp1 = ::g::Fuse::Controls::Image::New3();
    SourceLineNumber(1);
    SourceFileName(::STRINGS[0/*"Pages/board...*/]);
    temp->Margin(::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 70.0f));
    temp->SourceLineNumber(4);
    temp->SourceFileName(::STRINGS[0/*"Pages/board...*/]);
    ...
    temp1->SourceFileName(::STRINGS[0/*"Pages/board...*/]);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::accountBook_bundle::board220f8bc5()));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/]), temp);
}

// public board New(Fuse.Navigation.Router router) [static] :9
board* board::New5(::g::Fuse::Navigation::Router* router1)
{
    board* obj1 = (board*)uNew(board_typeof());
    obj1->ctor_8(router1);
    return obj1;
}
// }

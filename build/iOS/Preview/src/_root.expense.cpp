...
// public partial sealed class expense :2
// {
// static expense() :154
static void expense__cctor_4_fn(uType* __type)
{
    expense::__g_static_nametable1_ = uArray::Init<uString*>(::g::Uno::String_typeof()->Array(), 4, uString::Const("router"), uString::Const("theEach"), uString::Const("svp"), uString::Const("temp_eb18"));
    expense::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(uString::Const("Items"));
    expense::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(uString::Const("Value"));
    expense::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(uString::Const("theEach"));
    expense::__selector3_ = ::g::Uno::UX::Selector__op_Implicit(uString::Const("svp"));
}

static void expense_build(uType* type)
{
    ...
    type->SetFields(126,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(expense, router), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(uObject_typeof(), NULL), offsetof(expense, theEach_Items_inst), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Bool_typeof(), NULL), offsetof(expense, temp_Value_inst), 0,
        ::g::Fuse::Reactive::Each_typeof(), offsetof(expense, theEach), 0,
        ::g::Fuse::Controls::ScrollViewPager_typeof(), offsetof(expense, svp), 0,
        ::g::Fuse::Reactive::EventBinding_typeof(), offsetof(expense, temp_eb18), 0,
        ::g::Uno::UX::NameTable_typeof(), offsetof(expense, __g_nametable1), 0,
        ::g::Uno::String_typeof()->Array(), (uintptr_t)&expense::__g_static_nametable1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&expense::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&expense::__selector1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&expense::__selector2_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&expense::__selector3_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)expense__New5_fn, 0, true, type, 1, ::g::Fuse::Navigation::Router_typeof()));
}

::g::Fuse::Controls::Panel_type* expense_typeof()
{
    ...
    options.ObjectSize = sizeof(expense);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("expense", options);
    type->fp_build_ = expense_build;
    type->fp_cctor_ = expense__cctor_4_fn;
...
// public expense(Fuse.Navigation.Router router) :158
void expense__ctor_8_fn(expense* __this, ::g::Fuse::Navigation::Router* router1)
{
    __this->ctor_8(router1);
}

// private void InitializeUX() :164
void expense__InitializeUX_fn(expense* __this)
{
    __this->InitializeUX();
}

// public expense New(Fuse.Navigation.Router router) :158
void expense__New5_fn(::g::Fuse::Navigation::Router* router1, expense** __retval)
{
    *__retval = expense::New5(router1);
}

uSStrong<uArray*> expense::__g_static_nametable1_;
::g::Uno::UX::Selector expense::__selector0_;
::g::Uno::UX::Selector expense::__selector1_;
::g::Uno::UX::Selector expense::__selector2_;
::g::Uno::UX::Selector expense::__selector3_;

// public expense(Fuse.Navigation.Router router) [instance] :158
void expense::ctor_8(::g::Fuse::Navigation::Router* router1)
{
    uStackFrame __("expense", ".ctor(Fuse.Navigation.Router)");
    ctor_7();
    router = router1;
    InitializeUX();
}
...
void expense::InitializeUX()
{
    uStackFrame __("expense", "InitializeUX()");
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, expense::__g_static_nametable1_);
    theEach = ::g::Fuse::Reactive::Each::New4();
    theEach_Items_inst = ::g::accountBook_FuseReactiveEach_Items_Property::New1(theEach, expense::__selector0_);
    ...
    temp_Value_inst = ::g::accountBook_FuseTriggersWhileBool_Value_Property::New1(temp, expense::__selector1_);
    ...
    expense__Template* temp10 = expense__Template::New2(this, this);
    expense__Template1* temp11 = expense__Template1::New2(this, this);
    ...
    temp_eb18 = ::g::Fuse::Reactive::EventBinding::New1((uObject*)temp3);
    ::g::Fuse::Controls::Rectangle* temp16 = ::g::Fuse::Controls::Rectangle::New3();
    SourceLineNumber(1);
    SourceFileName(uString::Const("Pages/account/expense.ux"));
    temp4->LineNumber(3);
    temp4->FileName(uString::Const("Pages/account/expense.ux"));
    temp4->SourceLineNumber(3);
    temp4->SourceFileName(uString::Const("Pages/account/expense.ux"));
    temp4->File(::g::Uno::UX::BundleFileSource::New1(::g::accountBook_bundle::accountBook8f6bcc4a()));
    temp5->LineNumber(4);
    temp5->FileName(uString::Const("Pages/account/expense.ux"));
    temp5->SourceLineNumber(4);
    temp5->SourceFileName(uString::Const("Pages/account/expense.ux"));
    temp5->File(::g::Uno::UX::BundleFileSource::New1(::g::accountBook_bundle::expense268a8794()));
    temp6->SourceLineNumber(6);
    temp6->SourceFileName(uString::Const("Pages/account/expense.ux"));
    ...
    temp7->SourceFileName(uString::Const("Pages/account/expense.ux"));
    temp8->LayoutMode(1);
    temp8->SourceLineNumber(10);
    temp8->SourceFileName(uString::Const("Pages/account/expense.ux"));
    ...
    temp9->SourceFileName(uString::Const("Pages/account/expense.ux"));
    ...
    uPtr(theEach)->Name(expense::__selector2_);
    uPtr(theEach)->SourceLineNumber(13);
    uPtr(theEach)->SourceFileName(uString::Const("Pages/account/expense.ux"));
    ...
    temp1->SourceFileName(uString::Const("Pages/account/expense.ux"));
    temp->SourceLineNumber(31);
    temp->SourceFileName(uString::Const("Pages/account/expense.ux"));
    ...
    temp13->SourceFileName(uString::Const("Pages/account/expense.ux"));
    ...
    temp14->SourceFileName(uString::Const("Pages/account/expense.ux"));
    temp2->SourceLineNumber(31);
    temp2->SourceFileName(uString::Const("Pages/account/expense.ux"));
    uPtr(svp)->Name(expense::__selector3_);
    uPtr(svp)->SourceLineNumber(38);
    uPtr(svp)->SourceFileName(uString::Const("Pages/account/expense.ux"));
    uPtr(svp)->add_ReachedEnd(uDelegate::New(::g::Fuse::Controls::ScrollViewPager__ScrollViewPagerHandler_typeof(), (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb18)));
    uPtr(svp)->Each(theEach);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(svp)->Bindings()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL)), temp_eb18);
    temp3->SourceLineNumber(38);
    temp3->SourceFileName(uString::Const("Pages/account/expense.ux"));
    ...
    temp16->SourceFileName(uString::Const("Pages/account/expense.ux"));
...
// public expense New(Fuse.Navigation.Router router) [static] :158
expense* expense::New5(::g::Fuse::Navigation::Router* router1)
{
    expense* obj1 = (expense*)uNew(expense_typeof());
    obj1->ctor_8(router1);
    return obj1;
}
// }

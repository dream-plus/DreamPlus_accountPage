...
{
    ::STRINGS[0] = uString::Const("Pages/home.ux");
    ::STRINGS[1] = uString::Const("home Page");
...
{
    uStackFrame __("home", ".ctor(Fuse.Navigation.Router)");
    ctor_7();
    router = router1;
    InitializeUX();
}
...
void home::InitializeUX()
{
    ...
    SourceLineNumber(1);
    SourceFileName(::STRINGS[0/*"Pages/home.ux"*/]);
    temp->Value(::STRINGS[1/*"home Page"*/]);
    temp->FontSize(20.0f);
    temp->TextAlignment(1);
    temp->Color(::g::Uno::Float4__New2(0.6f, 0.6f, 0.6f, 1.0f));
    temp->Y(::g::Uno::UX::Size__New1(200.0f, 1));
    temp->SourceLineNumber(6);
    temp->SourceFileName(::STRINGS[0/*"Pages/home.ux"*/]);

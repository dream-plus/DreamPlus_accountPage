...
// {
// static schedule() :5
static void schedule__cctor_4_fn(uType* __type)
{
}

static void schedule_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Pages/schedule.ux");
    ...
    type->SetFields(126,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(schedule, router), 0);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)schedule__New5_fn, 0, true, type, 1, ::g::Fuse::Navigation::Router_typeof()));
}
...
::g::Fuse::Controls::Panel_type* schedule_typeof()
{
    ...
    options.ObjectSize = sizeof(schedule);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("schedule", options);
    type->fp_build_ = schedule_build;
    type->fp_cctor_ = schedule__cctor_4_fn;
...
// public schedule(Fuse.Navigation.Router router) :9
...
// public schedule New(Fuse.Navigation.Router router) :9
void schedule__New5_fn(::g::Fuse::Navigation::Router* router1, schedule** __retval)
{
    *__retval = schedule::New5(router1);
}

// public schedule(Fuse.Navigation.Router router) [instance] :9
void schedule::ctor_8(::g::Fuse::Navigation::Router* router1)
{
    uStackFrame __("schedule", ".ctor(Fuse.Navigation.Router)");
    ctor_7();
    router = router1;
    InitializeUX();
}
...
void schedule::InitializeUX()
{
    uStackFrame __("schedule", "InitializeUX()");
    ...
    temp1->Margin(::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 70.0f));
    temp1->SourceLineNumber(5);
    temp1->SourceFileName(::STRINGS[0/*"Pages/sched...*/]);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::accountBook_bundle::cal895572c9()));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/]), temp);
}

// public schedule New(Fuse.Navigation.Router router) [static] :9
schedule* schedule::New5(::g::Fuse::Navigation::Router* router1)
{
    schedule* obj1 = (schedule*)uNew(schedule_typeof());
    obj1->ctor_8(router1);
    return obj1;
}
// }
